...
inp['range']=np.array([[config['Imposed Limits']['Youngs Modulus'][0], config['Imposed Limits']['Yield Stress'][0], config['Imposed Limits']['Hardening Modulus'][0]], 
                       [config['Imposed Limits']['Youngs Modulus'][1], config['Imposed Limits']['Yield Stress'][1], config['Imposed Limits']['Hardening Modulus'][1]]])    
inp['s'] = config['s']                      
...
# initial covariance                          
inp['icov']=np.array([[config['Initial Variance']['Youngs Modulus'], 0, 0],[0, config['Initial Variance']['Yield Stress'], 0],
                      [0, 0, config['Initial Variance']['Hardening Modulus']]])                                   

# initial guesss of the parameters based on the prior
inp['theta0']=np.array([[config['Initial Material Parameters']['Youngs Modulus']],
...
ini = np.array([[config['True Material Parameters']['Youngs Modulus']], [config['True Material Parameters']['Yield Stress']],[config['True Material Parameters']['Hardening Modulus']]])
...
print('The median of the Y posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsA['MCMC'][1]), np.sqrt(np.var(resultsA['MCMC'][1]))))
print('The median of the H posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsA['MCMC'][2]), np.sqrt(np.var(resultsA['MCMC'][2]))))
print()
...
print('The median of the Y posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsB['MCMC'][1]), np.sqrt(np.var(resultsB['MCMC'][1]))))
print('The median of the H posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsB['MCMC'][2]), np.sqrt(np.var(resultsB['MCMC'][2]))))
print()
...
print('The median of the Y posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsC['MCMC'][1]), np.sqrt(np.var(resultsC['MCMC'][1]))))
print('The median of the H posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsC['MCMC'][2]), np.sqrt(np.var(resultsC['MCMC'][2]))))
print()
...
print('The median of the Y posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsD['MCMC'][1]), np.sqrt(np.var(resultsD['MCMC'][1]))))
print('The median of the H posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsD['MCMC'][2]), np.sqrt(np.var(resultsD['MCMC'][2]))))
print()
...
print('The median of the Y posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsE['MCMC'][1]), np.sqrt(np.var(resultsE['MCMC'][1]))))
print('The median of the H posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsE['MCMC'][2]), np.sqrt(np.var(resultsE['MCMC'][2]))))
print()
...
print('The median of the Y posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsF['MCMC'][1]), np.sqrt(np.var(resultsF['MCMC'][1]))))
print('The median of the H posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsF['MCMC'][2]), np.sqrt(np.var(resultsF['MCMC'][2]))))
print()
...
print('The median of the Y posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsG['MCMC'][1]), np.sqrt(np.var(resultsG['MCMC'][1]))))
print('The median of the H posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsG['MCMC'][2]), np.sqrt(np.var(resultsG['MCMC'][2]))))
print()
#plt.show()
...
# np.save('3D_chains_plas_3.npy', chains)