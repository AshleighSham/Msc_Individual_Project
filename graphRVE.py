...
read_dictionary['graphs'][3][-2][1] = np.array(read_dictionary['graphs'][3][-2][1]) /2.7

read_dictionary['graphs'][0][-1][1] = np.array(read_dictionary['graphs'][0][-1][1]) /2.3
read_dictionary['graphs'][1][-1][1] = np.array(read_dictionary['graphs'][1][-1][1]) /1.8
read_dictionary['graphs'][2][-1][1] = np.array(read_dictionary['graphs'][2][-1][1]) /2.2
...
for i, j, q in zip(read_dictionary['graphs'][0], read_dictionary['values'][0], range(7)):
    ...
    ax[0][0].plot([j], [-0.04], c = colours[q], marker = "|", markersize=18, markeredgewidth = 3)
...
for i, j, q in zip(read_dictionary['graphs'][1], read_dictionary['values'][1], range(7)):
    ...
    ax[1][0].plot([j], [-0.04], c = colours[q], marker = "|", markersize=18, markeredgewidth = 3)
...
for i, j, q in zip(read_dictionary['graphs'][2], read_dictionary['values'][2], range(7)):
    ...
    ax[0][1].plot([j], [-0.7], c = colours[q], marker = "|", markersize=18, markeredgewidth = 3)
...
for i, j, q in zip(read_dictionary['graphs'][3], read_dictionary['values'][3], range(7)):
    ...
    ax[1][1].plot([j], [-1.3], c = colours[q], marker = "|", markersize=18, markeredgewidth = 3, label = labels[q])

ax[0][0].plot([10], [-0.04], c = 'black', marker = "o", markersize=5, markeredgewidth = 3, label = 'True Value', alpha = 0.6)
ax[0][1].plot([0.3], [-0.7], c = 'black', marker = "o", markersize=5, markeredgewidth = 3, alpha = 0.6)
ax[1][0].plot([1], [-0.04], c = 'black', marker = "o", markersize=5, markeredgewidth = 3, alpha = 0.6)
ax[1][1].plot([0.3], [-1.3], c = 'black', marker = "o", markersize=5, markeredgewidth = 3, alpha = 0.6)
plt.tight_layout()
