...
#     ax[q][0].axhline(10, alpha = 0.8, c = 'k', linestyle=(0,(5,5)))
#     ax[q][0].set_ylim([-3,33])

# for i, q in zip(read_dictionary[1], range(7)):
#     ax[q][1].plot(range(len(i)), i, alpha = 0.8, c = colours[q])
#     ax[q][1].axhline(1, alpha = 0.8, c = 'k', linestyle=(0,(5,5)))
#     ax[q][1].set_ylim([-3,33])

# for i, q in zip(read_dictionary[2],  range(7)):
#     ax[q][2].plot(range(len(i)), i,  alpha = 0.8, c = colours[q])
#     ax[q][2].axhline(0.3, alpha = 0.8, c = 'k', linestyle=(0,(5,5)))
...
# ax[0][0].set_title("$E_I$ (GPa)")
# ax[0][1].set_title("$E_M$ (GPa)")
# ax[0][2].set_title("$v_I$")
# ax[0][3].set_title("$v_M$")
