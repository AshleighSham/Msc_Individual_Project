...
class DRAM_algorithm():
    def __init__(self, inp):
        ...
        # df.to_csv(r'C:\Users\ashle\Documents\GitHub\Portfolio\ES98C\Elasticity_2D_4DMCMC\EnKF.csv', mode='w', index=True)
    ...
    #     df.to_csv(r'C:\Users\ashle\Documents\GitHub\Portfolio\ES98C\Elasticity_2D_4DMCMC\EnKF.csv', mode='a', index=True, header = False)
