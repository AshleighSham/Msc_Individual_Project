...
print('The median of the Youngs Modulus posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsA['MCMC'][0]), 2*np.sqrt(np.var(resultsA['MCMC'][0]))))
print('The median of the Poissons Ratio posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsA['MCMC'][1]), 2*np.sqrt(np.var(resultsA['MCMC'][1]))))
print()
...
print('Number of Samples: %.0f' % config['Number of samples'])
print('The median of the Youngs Modulus posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsB['MCMC'][0]), 2*np.sqrt(np.var(resultsB['MCMC'][0]))))
print('The median of the Poissons Ratio posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsB['MCMC'][1]), 2*np.sqrt(np.var(resultsB['MCMC'][1]))))
print()
...
print('Number of Samples: %.0f' % config['Number of samples'])
print('The median of the Youngs Modulus posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsC['MCMC'][0]), 2*np.sqrt(np.var(resultsC['MCMC'][0]))))
print('The median of the Poissons Ratio posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsC['MCMC'][1]), 2*np.sqrt(np.var(resultsC['MCMC'][1]))))
print()
...
print('Number of Samples: %.0f' % config['Number of samples'])
print('The median of the Youngs Modulus posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsD['MCMC'][0]), 2*np.sqrt(np.var(resultsD['MCMC'][0]))))
print('The median of the Poissons Ratio posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsD['MCMC'][1]), 2*np.sqrt(np.var(resultsD['MCMC'][1]))))
print()
...
print('Number of Samples: %.0f' % config['Number of samples'])
print('The median of the Youngs Modulus posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsF['MCMC'][0]), 2*np.sqrt(np.var(resultsF['MCMC'][0]))))
print('The median of the Poissons Ratio posterior is: %f, with uncertainty +/- %.5f' % (np.median(resultsF['MCMC'][1]), 2*np.sqrt(np.var(resultsF['MCMC'][1]))))
print()
